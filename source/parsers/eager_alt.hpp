 ...
 *
 * A combinator that applies both alternatives and returns the one that got
 * further.
 */

#ifndef CPPCMB_PARSERS_EAGER_ALT_HPP
#define CPPCMB_PARSERS_EAGER_ALT_HPP
...
#endif /* CPPCMB_PARSERS_EAGER_ALT_HPP */
